...
import com.hugg.presentation.databinding.FragmentAccountBinding
import com.hugg.presentation.ui.main.account.adapter.AccountCardAdapter
import com.hugg.presentation.ui.main.account.bottomSheet.AccountDatePickBottomSheet
import com.hugg.presentation.util.ForeggNotification
    ...
    private val accountCardAdapter : AccountCardAdapter by lazy {
        AccountCardAdapter(object : AccountCardAdapter.AccountCardDelegate{
            ...
            override fun changeMode(selectMode: Boolean) {
                val res = if(selectMode) R.drawable.ic_delete_delete else R.drawable.ic_btn_add_filled_main
