...
import com.hugg.domain.usecase.auth.PostLoginUseCase
import com.hugg.domain.usecase.auth.PostRenewalFcmUseCase
    ...
    private fun getTutorialList() : List<OnboardingTutorialVo>{
        return listOf(
            ...
            OnboardingTutorialVo(
                ...
                img = R.drawable.onboarding_second
            ),
            OnboardingTutorialVo(
                ...
                img = R.drawable.onboarding_third
            ),
            OnboardingTutorialVo(
                ...
                img = R.drawable.onboarding_fourth
            )
        )
    }
